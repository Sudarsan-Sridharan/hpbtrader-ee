...
public class MarketData implements Comparable<MarketData> {
    ...
    // price fields
    private ValueStatusHolder<Double> bid = new ValueStatusHolder<>(HtrDefinitions.INVALID_PRICE, HtrEnums.ValueStatus.UNCHANGED);
    private ValueStatusHolder<Double> ask = new ValueStatusHolder<>(HtrDefinitions.INVALID_PRICE, HtrEnums.ValueStatus.UNCHANGED);
    private ValueStatusHolder<Double> last = new ValueStatusHolder<>(HtrDefinitions.INVALID_PRICE, HtrEnums.ValueStatus.UNCHANGED);
    
    // size fields
    private ValueStatusHolder<Integer> bidSize = new ValueStatusHolder<>(HtrDefinitions.INVALID_SIZE, HtrEnums.ValueStatus.UNCHANGED);
    private ValueStatusHolder<Integer> askSize = new ValueStatusHolder<>(HtrDefinitions.INVALID_SIZE, HtrEnums.ValueStatus.UNCHANGED);
    private ValueStatusHolder<Integer> lastSize = new ValueStatusHolder<>(HtrDefinitions.INVALID_SIZE, HtrEnums.ValueStatus.UNCHANGED);
    
    private ValueStatusHolder<Integer> volume = new ValueStatusHolder<>(HtrDefinitions.INVALID_SIZE, HtrEnums.ValueStatus.UNCHANGED);
    private ValueStatusHolder<Integer> callOpenInterest = new ValueStatusHolder<>(HtrDefinitions.INVALID_SIZE, HtrEnums.ValueStatus.UNCHANGED);
    private ValueStatusHolder<Integer> putOpenInterest = new ValueStatusHolder<>(HtrDefinitions.INVALID_SIZE, HtrEnums.ValueStatus.UNCHANGED);
    ...
    public void invalidatePrices() {
        bid.setValue(HtrDefinitions.INVALID_PRICE);
        ask.setValue(HtrDefinitions.INVALID_PRICE);
        last.setValue(HtrDefinitions.INVALID_PRICE);
    }
    
    public void invalidateSizes() {
        bidSize.setValue(HtrDefinitions.INVALID_SIZE);
        askSize.setValue(HtrDefinitions.INVALID_SIZE);
        lastSize.setValue(HtrDefinitions.INVALID_SIZE);
        volume.setValue(HtrDefinitions.INVALID_SIZE);
        callOpenInterest.setValue(HtrDefinitions.INVALID_SIZE);
        putOpenInterest.setValue(HtrDefinitions.INVALID_SIZE);
    }
    ...
    public Double getBidAskSpread() {
        return HtrUtil.round5(ask.getValue() - bid.getValue());
    }
